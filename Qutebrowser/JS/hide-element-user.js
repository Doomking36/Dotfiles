...
(function() {
	...
	document.addEventListener('sparkles-body-container', hideElements);
	document.addEventListener('sparkles-container', hideElements);
	document.addEventListener('rendering-content', hideElements);
})();
