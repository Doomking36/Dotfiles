...
// @inject-into page
// @license MIT
// @require     https://cdn.jsdelivr.net/npm/stylis@4.3.0/dist/umd/stylis.min.js
// @downloadURL https://update.greasyfork.org/scripts/482487/GreasyFork%20Dark.user.js
// @updateURL https://update.greasyfork.org/scripts/482487/GreasyFork%20Dark.meta.js
// ==/UserScript==
...
#script-info,.user-list,.text-content,.discussion-list {
    padding: 0 1em 1em
}

#script-info>*:last-child,.user-list>*:last-child,.text-content>*:last-child,.discussion-list>*:last-child {
    margin-bottom: 0
}
...
.discussion-header,.discussion-list-header {
    display: flex;
    margin-top: 30px;
    margin-bottom: 20px
}
...
.discussion-header>*:first-child,.discussion-list-header h2 {
    flex: 1;
    margin: 0!important
}

.discussion-header h2,.discussion-header .discussion-up-level {
    margin: 0
}
...
[dark] li.L9 {
  ...
  `
    ...
    const key01 = "7QdWEuQ5k6tH"
    const key02 = "SQwUKxgG4hoi"
    ...
    const mo = new MutationObserver(() => {
        ...
        const text = removeNonColor(cssTextFn());
